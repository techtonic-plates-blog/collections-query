...
#[sea_orm(table_name = "entry_relation_values")]
pub struct Model {
...
pub enum RelatedEntity {
    #[sea_orm(entity = "super::entries::Entity", def = "Relation::Entries2.def()")]
    Entries2,
    #[sea_orm(entity = "super::entries::Entity", def = "Relation::Entries1.def()")]
    Entries1,
