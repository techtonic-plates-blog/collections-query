...
use super::sea_orm_active_enums::DataTypes;
...
pub enum Relation {
    ...
    EntryObjectValues,
    #[sea_orm(has_many = "super::entry_relation_values::Entity")]
    EntryRelationValues,
...
impl Related<super::entry_relation_values::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::EntryRelationValues.def()
    }
}
...
pub enum RelatedEntity {
    ...
    EntryObjectValues,
    #[sea_orm(entity = "super::entry_relation_values::Entity")]
    EntryRelationValues,
